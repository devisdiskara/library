...
<head>
    ...
    <title>All Ebook - Flexilibrary</title>
        ...
        <div class="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          if (mysqli_num_rows($result_buku) > 0) {
            while ($row_buku = mysqli_fetch_assoc($result_buku)) {
              ...
              echo '<div class="rating" style="position: absolute; top: 10px; left: 10px; color: #000000; padding: 5px 10px; border-radius: 5px; font-weight: bold;">';
